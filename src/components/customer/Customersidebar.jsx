...
export default function CustomerSidebar({
  ...
  const getCurrentJobStatus = () => {
    try {
      ...
      const completedJobStatus =
        String(
          latestCompletedJob?.jobStatus ||
            latestCompletedJob?.job_status ||
            ""
        )
          .trim()
          .toUpperCase();
  ...
  // ======================================================
  // LOGOUT
  // Customer may logout at ANY stage.
  // The backend will restore the latest unfinished request
  // when Continue Existing Request is used again.
  // ======================================================
  ...
  // ======================================================
  // GO TO FEEDBACK
  // Only completed jobs should enter feedback.
  // ======================================================
              ...
              {canLeaveFeedback ? (
                <>
                  ...
                  <p className="mx-auto mt-4 max-w-sm text-sm leading-6 text-slate-400">
                    ...
                    Please share your experience before
                    finishing this service journey.
                  </p>
                  ...
                  <div className="mt-7 flex flex-col gap-3">
                    ...
                    <p className="text-[10px] leading-5 text-slate-500">
                      If you logout before submitting
                      feedback, you can use Continue
                      Existing Request later to return
                ...
                <>
                  ...
                  <p className="mx-auto mt-4 max-w-sm text-sm leading-6 text-slate-400">
                    Your service request will remain
                    saved. You can return later using
                    Continue Existing Request and
                    continue from the current service
                    stage.
                  </p>
                  ...
                  <div className="mt-7 flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-xl border border-red-500/40 bg-red-500/10 px-5 py-3 font-black text-red-300 transition hover:bg-red-500 hover:text-white"
                    >
                      <LogOut size={18} />
