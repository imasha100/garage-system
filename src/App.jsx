...
function App() {
  ...
  // Customer request data මෙතන save වෙනවා
  ...
  switch (currentPage) {
    ...
    case "technician-dashboard":
      return (
        <TechnicianLayout>
          <TechnicianDashboard onNavigate={setCurrentPage} />
        </TechnicianLayout>
      );
    ...
    case "technician-intake":
      return (
        <TechnicianLayout>
          <VehicleIntake onNavigate={setCurrentPage} />
        </TechnicianLayout>
      );
    ...
    case "technician-profile":
      return (
        <TechnicianLayout>
          <TechnicianProfile onNavigate={setCurrentPage} />
        </TechnicianLayout>
      );
    ...
    case "task-logs":
      return (
        <TechnicianLayout>
          <TaskHistory onNavigate={setCurrentPage} />
        </TechnicianLayout>
      );
